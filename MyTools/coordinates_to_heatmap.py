# ------------------------------------------------------------------------------
# # @Time    : 2020/3/18 下午 8:08
# # @Author  : fry
# @FileName: coordinates_to_heatmap.py
# ------------------------------------------------------------------------------
...
# Method 1
'''
一般用不到这种方法，只是可视化辅助用，生成比较慢
'''
def CenterGaussianHeatMap(c_x, c_y, img_width, img_height):
    #variance 可以自定义，默认21
    variance = 21
...
class Joints_data(object):
    ...
    def __init__(self, images):
        ...
        self.width = data_img.shape[1]
        self.height = data_img.shape[0]
        #关节数量
        self.num_joints = 15
        self.pixel_std = 200
        #热图类型
